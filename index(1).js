...
client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Olá @${num.split('@')[0]}\Bem vindo ao grupo *${mdata.subject}* que se sinta em casa aqui`
				...
				teks = `finalmente a carga do grupo é reduzida 𝟭, tchau🥳 @${num.split('@')[0]} seus serviços serão enterrados profundamente`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				...
				success: '️[SUSCESSO] comando feito! 🖤',
				error: {
					stick: 'Bem, falhei;(tente repetir ^_^',
					Iv: '𝗩𝗶𝘀𝗵 𝗟𝗶𝗻𝗸 𝗜𝗻𝘃𝗮𝗹𝗶𝗱𝗼 𝘁𝗲𝗻𝘁𝗮 𝗼𝘂𝘁𝗼☹️'
				},
				only: {
					group: '[❗] 𝗦𝗼𝗺𝗲𝗻𝘁𝗲 𝗲𝗺 𝗴𝗿𝘂𝗽𝗼𝘀 ',
					ownerG: '❬❗❭ 𝗦𝗢́ 𝗣𝗥𝗢𝗣𝗥𝗜𝗘𝗧𝗔́𝗥𝗜𝗢 ',
					ownerB: '❬❗❭  𝗦𝗢́ 𝗣𝗥𝗢𝗣𝗥𝗜𝗘𝗧𝗔́𝗥𝗜𝗢 ',
					admin: '❬❗❭𝗔𝗣𝗘𝗡𝗔𝗦 𝗔𝗗𝗜𝗠𝗜𝗡𝗜𝗦𝗧𝗥𝗔𝗗𝗢𝗥𝗘𝗦 ',
					Badmin: '❬❗❭ 𝗕𝗢𝗧 𝗦𝗘𝗠 𝗔𝗗𝗠! '
				}
			}
          ...
          case 'speed':
          case 'ping':
            await client.sendMessage(from, `Pong!!!!\nMinha velocidade -: ${processTime(t, moment())} _Segundos_`)
            break
				case 'help': 
				case 'menu':
            ...
            case 'kangcopet':
				...
				case 'info':
					...
					teks = `*NOME DO BOT* : ${me.name}\n*PROPRIETÁRIO* : *AMFIBI*\n*AUTHOR* : AMPIBI\n*Nomor Bot* : @${me.jid.split('@')[0]}\n*Prefix* : ${prefix}\n*CONTATOS BLOQUEADOS TOTAL* : ${blocked.length}\n*The bot is active on* : ${kyun(uptime)}`
					buffer = await getBuffer(me.imgUrl)
					client.sendMessage(from, buffer, image, {caption: teks, contextInfo:{mentionedJid: [me.jid]}})
					break
				case 'blocklist': 
					teks = '𝗢𝗦 𝗕𝗟𝗢𝗤𝗨𝗘𝗔𝗗𝗢𝗦 𝗞𝗦𝗞𝗦𝗞𝗦 :\n'
                ...
                case 'neko':
                    ...
                    client.sendMessage(from, buf, image, { quoted: mek, caption: 'Ta Ai Mano!'})
                break
                case 'dewabatch':
                    teks = body.slice(11)
                ...
                case 'anjing':
					...
					break
                case 'spamcall':
                   if (args.length < 1) return ('insira o número de destino Bambangg')
                   weha = body.slice(10)
                ...
                case 'indohot':
                   ...
                   break
				case 'ytmp4':
					if (args.length < 1) return reply('Cade o Url Mano?')
				...
				case 'ocr': 
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply('𝗠𝗮𝗻𝗱𝗲 𝘂𝗺𝗮 𝗳𝗼𝘁𝗼 𝗰𝗼𝗺 𝗲𝘀𝘀𝗮 𝗼𝗽𝗰̧𝗮̃𝗼! ${prefix}𝗼𝗰𝗿')
					}
					break
				case 'stiker': 
				case 'sticker':
            ...
            break	
				...
				case 'setprefix':
					...
					if (!isOwner) return reply(mess.only.ownerB)
					prefix = args[0]
					reply(`𝐏𝐑𝐄𝐅𝐈𝐗𝐎 𝐅𝐎𝐈 𝐀𝐋𝐓𝐄𝐑𝐀𝐃𝐎 𝐏𝐀𝐑𝐀 -> : ${prefix}`)
					break 
				case 'hilih': 
					if (args.length < 1) return reply('amo o texto, E aqui ta faltando^_^!!!')
					anu = await fetchJson(`https://mhankbarbars.herokuapp.com/api/hilih?teks=${body.slice(7)}`, {method: 'get'})
					reply(anu.result)
					break
				case 'tiktokstalk':
					try {
						if (args.length < 1) return client.sendMessage(from, '𝗖𝗮𝗱𝗲̂ 𝗼 𝗻𝗼𝗺𝗲 𝗱𝗼 𝘂𝘀𝘂𝗮́𝗿𝗶𝗼 𝗺𝗮𝗻𝗼?', text, {quoted: mek})
						...
						reply('[𝗘𝗥𝗥𝗢] 𝗡𝗼𝗺𝗲 𝗶𝗻𝘃𝗮́𝗹𝗶𝗱𝗼 𝗢𝘂 𝗡𝗮̃𝗼 𝗲𝘅𝗶𝘀𝘁𝗲')
					}
					break
				case 'fitnah':	
				case 'fake':          
               if (!isGroup) return reply(mess.only.group)
				...
				case 'clearall':
					...
					reply('_limpar tudo foi bem sucedido_  :)')
					break
			       case 'block':
				 ...
				 client.chatRead (from)
					...
					client.sendMessage(from, `𝗣𝗲𝗱𝗶𝗱𝗼𝘀 𝗿𝗲𝗰𝗲𝗯𝗶𝗱𝗼𝘀, 𝗲𝗺 𝗮𝗯𝗲𝗿𝘁𝗼 ${body.slice(9)}@c.us`, text)
				break
				case 'leave': 
				if (!isGroup) return reply(mess.only.group)
					if (!isOwner) return reply(mess.only.ownerB)
				await client.leaveGroup(from, 'Tchau Galerinha flw', groupId)
                    break
				case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `❮ 𝗧𝗥𝗔𝗡𝗦𝗠𝗜𝗦𝗦𝗔̃𝗢 𝗗𝗘 𝗣𝗘𝗗𝗜𝗗𝗢𝗦 ❯\n\n${body.slice(4)}`})
						}
						reply('𝗧𝗥𝗔𝗡𝗦𝗠𝗜𝗦𝗦𝗔̃𝗢 𝗙𝗘𝗜𝗧𝗔 𝗖𝗢𝗠 𝗦𝗨𝗖𝗘𝗦𝗦𝗢 ')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `❮ 𝗧𝗥𝗔𝗡𝗦𝗠𝗜𝗦𝗦𝗔̃𝗢 𝗗𝗘 𝗣𝗘𝗗𝗜𝗗𝗢𝗦 ❯\n\n${body.slice(4)}`)
						}
						reply('𝗧𝗥𝗔𝗡𝗦𝗠𝗜𝗦𝗦𝗔̃𝗢 𝗙𝗘𝗜𝗧𝗔 𝗖𝗢𝗠 𝗦𝗨𝗖𝗘𝗦𝗦𝗢 ')
					}
					break
			   	case 'setpp': 
                       ...
                       media = await client.downloadAndSaveMediaMessage(mek)
                        ...
                        reply(𝗔𝗹𝘁𝗲𝗿𝗲𝗶 𝗼 𝗶́𝗰𝗼𝗻𝗲 𝗱𝗼 𝗴𝗿𝘂𝗽𝗼 𝗰𝗼𝗺 𝘀𝘂𝗰𝗲𝘀𝘀𝗼'')
                break						
				case 'add':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
					...
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args[0] === 'buka') {
					    reply(`𝗚𝗿𝘂𝗽𝗼 𝗮𝗯𝗲𝗿𝘁𝗼 𝗰𝗼𝗺 𝘀𝘂𝗰𝗲𝘀𝘀𝗼`)
						client.groupSettingChange(from, GroupSettingChange.messageSend, false)
					} else if (args[0] === 'tutup') {
						reply(`𝗚𝗿𝘂𝗽𝗼 𝗙𝗲𝗰𝗵𝗮𝗱𝗼 𝗰𝗼𝗺 𝗦𝘂𝗰𝗲𝘀𝘀𝗼`)
       ...
       client.sendMessage(from, 'Este é o número do meu proprietário> _ <, não envie spam ou vou bloquear você',MessageType.text, { quoted: mek} )
           break    
           case 'setname':
                if (!isGroup) return reply(mess.only.group)
			    if (!isGroupAdmins) return reply(mess.only.admin)
                ...
                client.sendMessage(from, 'Sucesso em alterar, o nome do grupo', text, {quoted: mek})
                break
                case 'setdesc':
                if (!isGroup) return reply(mess.only.group)
			    if (!isGroupAdmins) return reply(mess.only.admin)
           ...
           case 'demote':
					...
					if (mentioned.length > 1) {
						...
						for (let _ of mentioned) {
							teks += `𝗕𝗲𝗺, 𝘀𝘂𝗮 𝗽𝗼𝘀𝗶𝗰̧𝗮̃𝗼 𝗱𝗲 𝗮𝗱𝗺𝗶𝗻𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝗿 𝗳𝗼𝗶 𝗿𝗲𝗺𝗼𝘃𝗶𝗱𝗮🏃 :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					} else {
						mentions(`𝗦𝗶𝗺𝗺 @${mentioned[0].split('@')[0]} 𝘀𝘂𝗮 𝗽𝗼𝘀𝗶𝗰̧𝗮̃𝗼 𝗱𝗲 𝗮𝗱𝗺𝗶𝗻𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝗿 𝗳𝗼𝗶 𝗿𝗲𝗺𝗼𝘃𝗶𝗱𝗮🏃`, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					}
					break
				case 'promote':
					...
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
							teks += `𝗣𝗮𝗿𝗮𝗯𝗲́𝗻𝘀🥳 𝗽𝗼𝗿 𝘀𝗲 𝘁𝗼𝗿𝗻𝗮𝗿 𝘂𝗺 𝗮𝗱𝗺𝗶𝗻𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝗿 𝗱𝗲 𝗴𝗿𝘂𝗽𝗼😎(+_+) :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					} else {
						mentions(`𝗣𝗮𝗿𝗮𝗯𝗲́𝗻𝘀🥳 @${mentioned[0].split('@')[0]} 𝘃𝗼𝗰𝗲̂ 𝘀𝗲 𝘁𝗼𝗿𝗻𝗼𝘂 𝗼 𝗮𝗱𝗺𝗶𝗻𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝗿 𝗱𝗼 𝗴𝗿𝘂𝗽𝗼 (+_+)`, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					}
					break	
			     	case 'kick':
					...
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
							teks += `Asek pegou um pouco de comida, otw chute 🏃 :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
						client.groupRemove(from, mentioned)
					} else {
						mentions(`Asek Pega comida, otw chute @${mentioned[0].split('@')[0]} 🏃`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'listadmin':
					if (!isGroup) return reply(mess.only.group)
					teks = `𝗟𝗜𝗦𝗧𝗔 𝗗𝗘 𝗧𝗢𝗗𝗢𝗦 𝗢𝗦 𝗟𝗜𝗡𝗗𝗢𝗦 𝗔𝗗𝗠𝗦 𝗗𝗢 *${groupMetadata.subject}*\n𝗧𝗼𝘁𝗮𝗹 : ${groupAdmins.length}\n\n`
					no = 0
					...
					break
				case 'toimg':
					if (!isQuotedSticker) return reply('𝗔𝗱𝗲𝘀𝗶𝘃𝗼 𝗱𝗲 𝗿𝗲𝘀𝗽𝗼𝘀𝘁𝗮/𝗺𝗮𝗿𝗰𝗮𝗰̧𝗮̃𝗼 !')
					reply(mess.wait)
				...
				case 'welcome':
					...
					if (Number(args[0]) === 1) {
						...
						reply('[𝗦𝗨𝗖𝗘𝗦𝗦𝗢] 𝗔𝘁𝗶𝘃𝗮𝗻𝗱𝗼 𝗼 𝗿𝗲𝗰𝘂𝗿𝘀𝗼 𝗱𝗲 𝗯𝗼𝗮𝘀-𝘃𝗶𝗻𝗱𝗮𝘀/𝗲𝘀𝗾𝘂𝗲𝗿𝗱𝗮 𝗻𝗲𝘀𝘁𝗲 𝗴𝗿𝘂𝗽𝗼')
					} else if (Number(args[0]) === 0) {
						welkom.splice(from, 1)
						fs.writeFileSync('./src/welkom.json', JSON.stringify(welkom))
						reply('[𝗦𝗨𝗖𝗘𝗦𝗦𝗢] *desativado* 𝗼 𝗿𝗲𝗰𝘂𝗿𝘀𝗼 𝗱𝗲 𝗯𝗼𝗮𝘀-𝘃𝗶𝗻𝗱𝗮𝘀/𝗲𝘀𝗾𝘂𝗲𝗿𝗱𝗮 𝗻𝗲𝘀𝘁𝗲 𝗴𝗿𝘂𝗽𝗼')
					} else {
				...
				case 'clone':
					...
					try {
						...
						reply(' *Bem, falhei; (tente repetir ^_^* ')
					}
					break
				case 'wait':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply(' *VOCE ENVIOU UMA FOTO? DE ANIME?* ')
					}
					break
				default:
